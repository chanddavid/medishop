...
from .models import Company, CompanyBank, Medicine, MedicalDetails, BillDetails, EmployeeSalary, EmployeeBank, \
    CompanyAccount, CustomerRequest, Bill, Customer, Employee
...
class CompanyBankSerializer(serializers.ModelSerializer):
    ...
    # companybank ma company ko id hunxa so kun company ko id bhanera sub company ko detail dinxa
